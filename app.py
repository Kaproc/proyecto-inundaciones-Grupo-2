...
def descargar_de_drive(file_id, output_path):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"Error descargando {file_id}")
    except Exception as e:
        print(f"Excepción: {e}")

# Preparar carpetas (Render a veces borra cosas, así que esto asegura que existan)
...
<head>
    ...
    <style>
        ...
        /* Estilo Hover */
        .custom-tooltip {
            background: white; border: 1px solid #001f3f; color: #001f3f; font-weight: bold; font-size: 12px;
        }
    </style>
</head>
<body>
    ...
    <script>
        ...
        const urlJson = '/static/{{NOMBRE_JSON}}';
        const urlCsv = '/static/{{NOMBRE_CSV}}';
